...
// +k8s:conversion-gen=github.com/capitalrx/grafana/apps/dashboard/pkg/apis/dashboard
...
package v2alpha1 // import "github.com/capitalrx/grafana/apps/dashboard/pkg/apis/dashboard/v2alpha1"
