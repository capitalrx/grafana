...
import (
	...
	featuretoggleapi "github.com/capitalrx/grafana/pkg/apis/featuretoggle/v0alpha1"
...
<!-- https://github.com/capitalrx/grafana/blob/main/pkg/services/featuremgmt/toggles_gen_test.go#L27 -->
