...
// go test -benchmem -run=^$ -bench=BenchmarkReadPrometheusStyleResult_FromFile$ github.com/capitalrx/grafana/pkg/promlib/converter/ -memprofile pmem.out -count 6 | tee pmem.0.txt
