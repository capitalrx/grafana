...
func (b *SnapshotsAPIBuilder) GetAPIRoutes(gv schema.GroupVersion) *builder.APIRoutes {
	...
	createCmd := defs["github.com/capitalrx/grafana/apps/dashboard/pkg/apissnapshot/v0alpha1.DashboardCreateCommand"].Schema
	...
	createRsp := defs["github.com/capitalrx/grafana/apps/dashboard/pkg/apissnapshot/v0alpha1.DashboardCreateResponse"].Schema
...
func (b *SnapshotsAPIBuilder) GetAuthorizer() authorizer.Authorizer {
	...
	//
	// https://github.com/capitalrx/grafana/blob/f63e43c113ac0cf8f78ed96ee2953874139bd2dc/pkg/middleware/auth.go#L203
