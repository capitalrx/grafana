...
- Modify the [`availableIconsIndex` map in `@grafana/data`](https://github.com/capitalrx/grafana/blob/main/packages/grafana-data/src/types/icon.ts#L1) and add the new icon
