...
export class AnnoListPanel extends PureComponent<Props, State> {
  ...
  async doSearch() {
    ...
    // https://github.com/capitalrx/grafana/blob/main/public/app/core/services/backend_srv.ts
    // https://github.com/capitalrx/grafana/blob/main/public/app/features/annotations/annotations_srv.ts
