...
4. (Optional) Report the issue you were experiencing on the [Grafana repository](https://github.com/capitalrx/grafana/issues). Tag the issue with "datasource/migrate-prometheus-type"
