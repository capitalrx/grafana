...
In addition to what is summarized here, you might also be interested in our announcement blog post. For all the technical details, check out the complete [CHANGELOG.md](https://github.com/capitalrx/grafana/blob/main/CHANGELOG.md).
...
Tests are most likely to be affected. There are some tips for fixing these in the original pull request at [https://github.com/capitalrx/grafana/pull/36398](https://github.com/capitalrx/grafana/pull/36398).
