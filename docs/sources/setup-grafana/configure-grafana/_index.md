...
By default, Grafana installs some suggested plugins on startup. For a list of default preinstalled plugins, refer to [pkg/setting/setting_plugins.go:35](https://github.com/capitalrx/grafana/blob/main/pkg/setting/setting_plugins.go#L35-L40).
